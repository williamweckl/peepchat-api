defmodule Peepchat.UserTest do
  ...
  @valid_attrs %{email: "email@example.com", password: "abcde12345", password_confirmation: "abcde12345"}
  @invalid_attrs %{}
  ...
  test "mis-matched password_confirmation doesn't work" do
    changeset = User.changeset(%User{}, %{@valid_attrs | password_confirmation: "b1bk23jkn12"})
    refute changeset.valid?
  end
